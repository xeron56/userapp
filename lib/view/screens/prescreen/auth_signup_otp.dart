...
import 'package:flutter_restaurant/view/screens/prescreen/auth_signup_phone.dart';

class AuthSignupOtp extends StatefulWidget {
  AuthSignupOtp({Key key}) : super(key: key);

  @override
  _AuthSignupOtpState createState() => _AuthSignupOtpState();
}

class _AuthSignupOtpState extends State<AuthSignupOtp> {
  @override
                        ...
                        children: [
                          ...
                          FlatButton.icon(
                            onPressed: () {
                              ...
                              Navigator.of(context).pushReplacement(MaterialPageRoute(builder: (BuildContext context) => AuthSignupPhone()));
                            },
                            label: Text(
                              "Sign Up",
                            ),
